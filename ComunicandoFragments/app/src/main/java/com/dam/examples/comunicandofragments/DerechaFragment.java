 ...
 */
public class DerechaFragment extends Fragment implements View.OnClickListener {
     ...
     * @return A new instance of fragment DerechaFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Implementamos listener boton
        boton = (Button) v.findViewById(R.id.bDrcha);
        //Cogemos el texto
        texto = (TextView) v.findViewById(R.id.tDrcha);
        boton.setOnClickListener(this);
        return v;
    }

    //COMENTAOMOS ESTE CÓDIGO YA QUE VAMOS A IMPLEMENTAR NUESTRO PROPIO CÓDIGO
    ...
    public void onClick(View v) {
        ...
        mListener.onFragmentInteraction(1,"ADIOS");
    }
    /**
